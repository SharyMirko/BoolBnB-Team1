...
@endphp
         ...
         <div class="d-flex align-items-center py-4">
            ...
            <div class="ms-3">
               <p class="category m-0">inviato da</p>
               <h4 class="my-0">{{$message->email_sender}}</h4>
               <p class="category">per l'appartamento</p>
               <p class="price-text m-0">
                @php
                    
                    foreach ($userApart as $apartment) {
            ...
            <div class="ms-auto d-flex flex-column">
               ...
               <div class="d-flex">
                  <a href="{{ route('apartments.show', $message->apartment_id) }}" class="btn btn-primary text-white me-2"><i class="fa-solid fa-eye"></i></a>
